...
import { ChartTooltipContent, ChartTooltip, ChartContainer, ChartConfig } from "./ui/chart"
import { CartesianGrid, Line, LineChart, XAxis } from "recharts"
import { PlusIcon, SmileIcon,ClockIcon, TicketIcon, BarChartIcon, LineChartIcon, TrendingUp, EyeIcon } from 'lucide-react'
      ...
      <div className="flex items-center justify-between py-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button variant="outline">
            ...
            {usersLoggedin === false ? 0 : {usersLoggedin}}
           <span className='ml-2 hidden md:block'>Logged in</span>
          </Button>
        </div>
      </div>
    </header>
          ...
          <div className="grid gap-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="grid gap-1">
                ...
                <div className="text-sm text-muted-foreground">I need to return an item, how do I do that?</div>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <Avatar className="w-10 h-10 border">
